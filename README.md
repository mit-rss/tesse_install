...
To check that you installed the ROS bridge correctly, run the following command:

`roslaunch tesse_ros_bridge tesse_bridge.launch`

It should start repeatedly setting intrinsic parameters for lidar without throwing any errors.
...
For example: on my machine, my VM IP is 172.16.18.128 and my host IP is 172.16.18.1, where the matching subnet is 172.16.18.
